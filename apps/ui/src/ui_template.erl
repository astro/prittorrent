...
explain_error1(_, connection_closed) ->
    <<"Connection closed">>;
explain_error1(_, {xml_parser, parsing, parsing_failed, {_, Message}})
  when is_list(Message) ->
    list_to_binary([<<"XML parser error: ">>, Message]);
explain_error1(_, {xml_parser, _, _, _}) ->
    <<"XML parser error">>;
explain_error1(_Scope, _Term) ->
    <<"Internal error">>.
